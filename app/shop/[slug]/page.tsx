...
export default function ProductPage({ params }: { params: { slug: string } }) {
  ...
  const images = product.images?.length ? product.images : [product.images?.[0]].filter(Boolean);
          ...
          <aside className="lg:sticky lg:top-10 h-fit space-y-6">
            ...
            <div className="space-y-3">
              ...
              <p className="text-[11px] leading-5 text-stone-500">
                Seleccionaste talla <span className="font-semibold text-stone-300">{activeSize}</span>.
                Carrito y checkout se conectan en la siguiente fase.
              </p>
            </div>
